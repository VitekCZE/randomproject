      ...
      <main className="relative flex w-full flex-col overflow-hidden items-center">
        ...
        <section className="container mx-auto px-8 py-16 relative">
          <div className="flex flex-col md:flex-row">
            {/* Steps Column with Centered Timeline */}
            <div className="md:w-2/3 relative">
              {/* Centered Timeline Line with grow animation */}
              <div className="absolute left-1/2 transform -translate-x-1/2 top-0 bottom-0 w-[2px] bg-[rgba(45,175,229,0.3)]">
                <div 
              ...
              <div className="bg-[rgba(50,50,50,0.7)] p-6 mb-8 max-w-2xl mx-auto animate-fade-in">
